...
#define FRUIT_MIN_DURATION 32
#define FRUIT_MAX_DURATION 48
#define POWER_MODE_DURATION 35
#define READY_DELAY_TIME 5
#define GHOST_RELEASE_INTERVAL 10

// 공통 열거형
typedef enum { 
    STATE_TITLE, STATE_HELP, STATE_READY, STATE_PLAYING, 
    STATE_PACMAN_DEATH, STATE_LEVEL_COMPLETE, STATE_GAME_OVER, 
...
typedef enum { 
    MENU_START_GAME = 0, MENU_HOW_TO_PLAY, 
